...
class LoungeCharts extends Component{
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        return (
            <Container>
                <br></br>
                <h1 className="statTitle">Lounge Statistics</h1>
                <Row>
                    <Col>
                        <canvas
                            id="loungeHumidChart"
